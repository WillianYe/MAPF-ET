...
// ZERO: f=g
// CG, DG, WDG: f=g+h
// GLOBAL, PATH, LOCAL, CONFLICT: inadmissible heuristics
...
public:
	...
	uint64_t num_memoization = 0; // number of times when memeorization helps
	 ...
	 //stats
	 // <agent 1, agent 2, node, number of expanded CT nodes, h value> 
	list<tuple<int, int, const HLNode*, uint64_t, int> > sub_instances; 	
...
protected:
	...
	// runtime reduction techniques。DG WDG用。memorization用，记忆化，是减少计算时间的技巧之一
